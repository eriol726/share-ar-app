...
public class RemoteRenderer {
    private static final String TAG = RemoteRenderer.class.getSimpleName();

    // Shader names.
    private static final String VERTEX_SHADER_NAME = "shaders/remotescreen.vert";
    private static final String FRAGMENT_SHADER_NAME = "shaders/remotescreen.frag";
...
//    GLES20.glTexParameteri(textureTarget, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
        ...
        GLUtils.texImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, textureBitmap, 0);
    ...
    /**
     * Draws the camera image using the currently configured {@link RemoteRenderer#quadTexCoords}
    ...
    private void draw() {
        ...
        ShaderUtil.checkGLError(TAG, "RemoteRendererDraw");
    }
