...
public class WebRtcClient {
    ...
    private class CreateOfferCommand implements Command {
        public void execute(String peerId, JSONObject payload) throws JSONException {
            ...
            Log.d(TAG, "getLocalDescription(): " + peer.pc.getLocalDescription());

            //sendMessage(peerId, "offer", payload, deviceName);
    ...
    private class CreateAnswerCommand implements Command {
        public void execute(String peerId, JSONObject payload) throws JSONException {
            ...
            Log.d(TAG, "CreateAnswerCommand sdp: " + sdp.type);
     ...
     */
    public void sendMessage(String to, String type, JSONObject payload, String deviceName) throws JSONException {
    ...
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        /*
            this is callad when we pair to units
         */
        @Override
        public void onCreateSuccess(final SessionDescription sdp) {
            ...
            try {
                ...
                sendMessage(id, sdp.type.canonicalForm(), payload, deviceName);
        ...
        public void onIceCandidate(final IceCandidate candidate) {
            try {
                ...
                sendMessage(id, "candidate", payload, deviceName);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
    ...
    /**
     * Call this method in Activity.onRemove()
     */
